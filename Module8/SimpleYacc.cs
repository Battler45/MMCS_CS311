...
public enum Tokens {
    ...
    COLUMN=19,PERCENT=20,MOD=21,IF=22,THEN=23,ELSE=24,
    WHILE=25,DO=26,REPEAT=27,UNTIL=28,INUM=29,RNUM=30,
    ID=31};
...
#pragma warning restore 649
  ...
  static Parser() {
    ...
    states[4] = new State(new int[]{31,18,3,4,5,33,11,37,12,42,22,50,25,57,27,62,4,-14,10,-14},new int[]{-17,5,-6,66,-7,9,-3,10,-8,31,-9,32,-10,36,-12,41,-11,48,-14,49,-15,56,-16,61});
    states[5] = new State(new int[]{4,6,10,7});
    states[6] = new State(-27);
    states[7] = new State(new int[]{31,18,3,4,5,33,11,37,12,42,22,50,25,57,27,62,4,-14,10,-14,28,-14},new int[]{-6,8,-7,9,-3,10,-8,31,-9,32,-10,36,-12,41,-11,48,-14,49,-15,56,-16,61});
    states[8] = new State(-4);
    states[9] = new State(-5);
    states[10] = new State(new int[]{6,11});
    states[11] = new State(new int[]{31,18,29,19,17,20},new int[]{-2,12,-4,30,-5,29,-3,17});
    states[12] = new State(new int[]{13,13,14,23,4,-16,10,-16,28,-16,24,-16});
    states[13] = new State(new int[]{31,18,29,19,17,20},new int[]{-4,14,-5,29,-3,17});
    states[14] = new State(new int[]{15,15,16,25,21,27,13,-17,14,-17,4,-17,10,-17,28,-17,24,-17,18,-17,31,-17,3,-17,5,-17,11,-17,12,-17,22,-17,25,-17,27,-17,23,-17,26,-17});
    states[15] = new State(new int[]{31,18,29,19,17,20},new int[]{-5,16,-3,17});
    states[16] = new State(-20);
    states[17] = new State(-24);
    states[18] = new State(-15);
    states[19] = new State(-25);
    states[20] = new State(new int[]{31,18,29,19,17,20},new int[]{-2,21,-4,30,-5,29,-3,17});
    states[21] = new State(new int[]{18,22,13,13,14,23});
    states[22] = new State(-26);
    states[23] = new State(new int[]{31,18,29,19,17,20},new int[]{-4,24,-5,29,-3,17});
    states[24] = new State(new int[]{15,15,16,25,21,27,13,-18,14,-18,4,-18,10,-18,28,-18,24,-18,18,-18,31,-18,3,-18,5,-18,11,-18,12,-18,22,-18,25,-18,27,-18,23,-18,26,-18});
    states[25] = new State(new int[]{31,18,29,19,17,20},new int[]{-5,26,-3,17});
    states[26] = new State(-21);
    states[27] = new State(new int[]{31,18,29,19,17,20},new int[]{-5,28,-3,17});
    states[28] = new State(-22);
    states[29] = new State(-23);
    states[30] = new State(new int[]{15,15,16,25,21,27,13,-19,14,-19,4,-19,10,-19,28,-19,24,-19,18,-19,31,-19,3,-19,5,-19,11,-19,12,-19,22,-19,25,-19,27,-19,23,-19,26,-19});
    states[31] = new State(-6);
    states[32] = new State(-7);
    states[33] = new State(new int[]{31,18,29,19,17,20},new int[]{-2,34,-4,30,-5,29,-3,17});
    states[34] = new State(new int[]{13,13,14,23,31,18,3,4,5,33,11,37,12,42,22,50,25,57,27,62,4,-14,10,-14,28,-14,24,-14},new int[]{-6,35,-7,9,-3,10,-8,31,-9,32,-10,36,-12,41,-11,48,-14,49,-15,56,-16,61});
    states[35] = new State(-28);
    states[36] = new State(-8);
    states[37] = new State(new int[]{17,38});
    states[38] = new State(new int[]{31,18,29,19,17,20},new int[]{-2,39,-4,30,-5,29,-3,17});
    ...
    states[43] = new State(new int[]{31,18},new int[]{-13,44,-3,47});
    states[44] = new State(new int[]{19,45,4,-31,10,-31,28,-31,24,-31});
    states[45] = new State(new int[]{31,18},new int[]{-3,46});
    states[46] = new State(-33);
    states[47] = new State(-32);
    states[48] = new State(-10);
    states[49] = new State(-11);
    states[50] = new State(new int[]{31,18,29,19,17,20},new int[]{-2,51,-4,30,-5,29,-3,17});
    states[51] = new State(new int[]{23,52,13,13,14,23});
    states[52] = new State(new int[]{31,18,3,4,5,33,11,37,12,42,22,50,25,57,27,62,4,-14,10,-14,28,-14,24,-14},new int[]{-6,53,-7,9,-3,10,-8,31,-9,32,-10,36,-12,41,-11,48,-14,49,-15,56,-16,61});
    states[53] = new State(new int[]{24,54,4,-35,10,-35,28,-35});
    states[54] = new State(new int[]{31,18,3,4,5,33,11,37,12,42,22,50,25,57,27,62,4,-14,10,-14,28,-14,24,-14},new int[]{-6,55,-7,9,-3,10,-8,31,-9,32,-10,36,-12,41,-11,48,-14,49,-15,56,-16,61});
    states[55] = new State(-34);
    states[56] = new State(-12);
    states[57] = new State(new int[]{31,18,29,19,17,20},new int[]{-2,58,-4,30,-5,29,-3,17});
    states[58] = new State(new int[]{26,59,13,13,14,23});
    states[59] = new State(new int[]{31,18,3,4,5,33,11,37,12,42,22,50,25,57,27,62,4,-14,10,-14,28,-14,24,-14},new int[]{-6,60,-7,9,-3,10,-8,31,-9,32,-10,36,-12,41,-11,48,-14,49,-15,56,-16,61});
    states[60] = new State(-36);
    states[61] = new State(-13);
    states[62] = new State(new int[]{31,18,3,4,5,33,11,37,12,42,22,50,25,57,27,62,28,-14,10,-14},new int[]{-17,63,-6,66,-7,9,-3,10,-8,31,-9,32,-10,36,-12,41,-11,48,-14,49,-15,56,-16,61});
    states[63] = new State(new int[]{28,64,10,7});
    states[64] = new State(new int[]{31,18,29,19,17,20},new int[]{-2,65,-4,30,-5,29,-3,17});
    states[65] = new State(new int[]{13,13,14,23,4,-37,10,-37,28,-37,24,-37});
    ...
    rules[15] = new Rule(-3, new int[]{31});
    ...
    rules[22] = new Rule(-4, new int[]{-4,21,-5});
    rules[23] = new Rule(-4, new int[]{-5});
    rules[24] = new Rule(-5, new int[]{-3});
    rules[25] = new Rule(-5, new int[]{29});
    ...
    rules[34] = new Rule(-14, new int[]{22,-2,23,-6,24,-6});
    rules[35] = new Rule(-14, new int[]{22,-2,23,-6});
    rules[36] = new Rule(-15, new int[]{25,-2,26,-6});
    rules[37] = new Rule(-16, new int[]{27,-17,28,-2});
  }
